{{-- Recommended Groups Form --}}
<div id="step-five" class="flex justify-center items-start animate-fade-in flex-1 sm:py-10 sm:items-center">
    <div class="max-w-[580px] w-full p-0 sm:border-[0.5px] sm:backdrop-blur-40 rounded-[24px] sm:p-[40px] sm:bg-custom5 sm:border-custom1">
        <div class="flex items-center justify-between">
            <button id="step-five-bk-btn" type="button" class="flex items-center transition-transform duration-200 hover:scale-105">
        ...
        <p class="text-xs text-custom4 leading-[22.4px] mt-1 mb-6 font-medium sm:mb-10 sm:text-base">
            Here are the groups you can follow based on your interest
        </p>
        ...
        <div class="flex items-center justify-between border-b-[0.3px] border-b-custom4 h-[75px] sm:h-20">
            ...
            <button type="button" data-group-id="1" class="follow-btn h-8 text-secondary text-xs font-medium border border-secondary px-4 rounded-[20px] leading-[19.67px] sm:text-base sm:h-10">
                Follow
            </button>
        </div>
        ...
        <div class="flex items-center justify-between border-b-[0.3px] border-b-custom4 h-[75px] sm:h-20">
            ...
            <button type="button" data-group-id="2" class="follow-btn h-8 text-secondary text-xs font-medium border border-secondary px-4 rounded-[20px] leading-[19.67px] sm:text-base sm:h-10">
                Follow
            </button>
        </div>
        ...
        <div class="flex items-center justify-between border-b-[0.3px] border-b-custom4 h-[75px] sm:h-20">
            ...
            <button type="button" data-group-id="3" class="follow-btn h-8 text-secondary text-xs font-medium border border-secondary px-4 rounded-[20px] leading-[19.67px] sm:text-base sm:h-10">
                Follow
            </button>
        </div>
